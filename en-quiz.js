        const questions = [
            {
                ...
                options: [
                    { text: "Just charge forward—it'll take me somewhere!", 
                        value: "Assavadevathin"},
                    { text: "Look for a river and follow the flow", 
                        value: "Davichmetha" },
                    { text: "Follow the guidance of the stars, moon, and sun", 
                        value: "Meenanagarin" },
            ...
            },
            {
                ...
                options: [
                    { text: "Leather sofa, cool to the touch", 
                        value: "Bhuchongpisut" },
                    { text: "Fabric sofa with smooth texture", 
                        value: "Assavadevathin" },
            ...
            },
            {
                ...
                options: [
                    { text: "Keep walking—they won't try to harm me and even if they did, I'd be ready", 
                        value: "Assavadevathin" },
            ...
            },
            {
                ...
                options: [
                    { text: "Go straight to the soft bed", 
                        value: "Assavadevathin" },
                    { text: "Prepare a hot bath and soak in", 
                        value: "Meenanagarin" },
                    { text: "Go for a relaxing massage", 
                        value: "Davichmetha" },
                    { text: "Eat dinner and drink my vitamins and supplements", 
                        value: "Bhuchongpisut" },
                ]
            },
            {
            ...
            },
            {
                ...
                options: [
                    { text: "In a hut on the beach", 
                        value: "Meenanagarin" },
                    { text: "In a cottage on the mountain", 
                        value: "Bhuchongpisut" },
...
function displayQuestion() {
    ...
    questionImageElement.innerHTML = `<img src="${currentQuestion.image}" alt="Question ${currentQuestion + 1}" height="200">`;
